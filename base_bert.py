#NOT modificatio needed
#initialize the weights init_wieghts,
#restore pre-trained weights from pretrained
...
class BertPreTrainedModel(nn.Module):
    ...
    #using the weights from HuggingFace, 
    @classmethod
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], *model_args, **kwargs):
        ...
        if pretrained_model_name_or_path is not None:
            ...
            if os.path.isdir(pretrained_model_name_or_path): # Load from a PyTorch checkpoint
            ...
            try:     # Load from URL or cache if already cached
